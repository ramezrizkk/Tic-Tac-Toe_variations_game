...
//--------------------------------------- Misère-X_O_Board Implementation

MisereXO_Board::MisereXO_Board() : Board(3, 3) {
...
//--------------------------------------- MisèreXO_UI Implementation

MisereXO_UI::MisereXO_UI() : UI<char> ("Welcome to FCAI Misere Tic-Tac-Toe Game", 3) {}
