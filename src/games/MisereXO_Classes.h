...
#ifndef MisèreXO_CLASSES_H
#define MisèreXO_CLASSES_H

#include "BoardGame_Classes.h"
using namespace std;

/**
 * @class MisèreXO_Board
 * @brief Represents the Tic-Tac-Toe game board.
 *
 * This class inherits from the generic `Board<char>` class and implements
 * the specific logic required for the Misère Tic-Tac-Toe (X-O) game, including
